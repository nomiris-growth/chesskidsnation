    ...
    <div className="flex min-h-screen flex-col bg-white pb-20 sm:pb-0">
      ...
      <main className="flex-1">
        ...
        <div className="flex justify-center bg-white px-4 py-6">
          <a href="#book-demo" className="kid-cta-btn inline-flex rounded-full px-7 py-3 text-sm font-black uppercase tracking-wide">
            Book a Demo Class
          </a>
        </div>
        <FeaturesSection />
        <div className="flex justify-center bg-[#fdfbf7] px-4 py-6">
          <a href="#book-demo" className="kid-cta-btn inline-flex rounded-full px-7 py-3 text-sm font-black uppercase tracking-wide">
            Book a Demo Class
          </a>
        </div>
